...
"""Run 10 AIMO3 Reference Benchmark with DeepSeek R1 (best open-weight)."""
...
# Create solver with DeepSeek R1
...
# Save results
outpath = "aimo/results/reference_deepseek_r1_results.json"
os.makedirs(os.path.dirname(outpath), exist_ok=True)
with open(outpath, "w") as f:
    json.dump({"model": "deepseek/deepseek-r1", "score": f"{correct}/{len(problems)}",
               "total_time": total_time, "results": results}, f, indent=2)
