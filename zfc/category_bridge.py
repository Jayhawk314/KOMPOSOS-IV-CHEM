...
class DualEngineBridge:
    ...
    ZFC runs first: proves logical entailments from the Category adapter.
    ...
    def classify_dual_result(cat_says: bool, zfc_says: bool) -> DeltaType:
        ...
        if not cat_says and zfc_says:
            return DeltaType.ORPHAN
        if cat_says and not zfc_says:
    ...
    def query(
        ...
        delta = self.classify_dual_result(cat_says=cat_says, zfc_says=zfc_says)
